...
const BLOG_POSTS = [
    {
        ...
        content: `
            ...
            <p>このゲームのルールは非常にシンプルですが、奥が深いのが特徴です。例えば、「はぁ」というお題に対して、プレイヤーにはそれぞれ異なるシチュエーションが割り当てられます。「怒りの『はぁ』」「とぼけの『はぁ』」「感心の『はぁ』」「失恋の『はぁ』」といった具合です。演者は身振り手振りを使わずに、自分の割り当てられたシチュエーションを声と表情だけで演じなければなりません。周囲のプレイヤーは、演者がどのシチュエーションで演じたのかを当て、見事正解すれば双方にポイントが入ります。</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p>これらを知っているだけで、ゲーム中の思考がクリアになり、頭脳戦が何倍もエキサイティングになります。東京ボードゲーム会では、初心者の方の習熟度に合わせておひげさんが優しくサポートしますので、安心して戦略ゲームの扉を叩いてください！</p>
    ...
    },
    {
        ...
        content: `
            <p>現代人は、朝起きてから寝る直前まで、スマートフォンやPCのブルーライトにさらされ続けています。SNSのスクロールや絶え間ない通知、仕事のチャットなど、脳は常に大量の情報処理を強いられ、オーバーヒート状態に陥っています。このデジタル疲労を解消するために注目されているのが、今世界的にブームが再燃している「アナログボードゲーム」による脳のリフレッシュです。</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p>どんな目的でその会が立ち上げられ、どのような人が運営しているのかがブログやSNSで発信されている会は、雰囲気が良く安心です。東京ボードゲーム会は、私自身が「普通のサラリーマンで3児 of パパ」であり、完璧ではない等身大の人間として運営しています。「楽しかった！また来たい」と参加者全員が笑顔になれるようなアットホームで温かい空間作りを最優先にしていますので、まずは安心してお気軽にお越しください！</p>
