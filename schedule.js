...
const BLOG_POSTS = [
    ...
    },
    {
        ...
        summary: "世界中で大ヒットしているボードゲーム「カタン」の基本ルールと、初心者がすぐに実践できる簡単な攻略のコツを、初心者向けにどこよりもわかりやすく解説します。",
        imagePath: "images/event_catan.jpg",
        content: `
            ...
            <p>今回は、人生ゲームくらいしかやったことがないという初心者の方に向けて、カタンの基本ルールと、初心者がすぐに実践できる簡単な攻略のコツを、どこよりもわかりやすく解説します！</p>
            ...
            <h2 style="font-size: 1.4rem; font-weight: 900; margin-top: 40px; margin-bottom: 20px; color: var(--color-text-main); border-bottom: 2px solid var(--color-primary-light); padding-bottom: 8px;">【初心者向け】カタンで勝つための簡単な攻略・コツ</h2>
            <p>カタンで遊ぶ際、初心者の方が少しだけ意識すると劇的にゲームが面白くなる、簡単な攻略 of コツを3つ紹介します。</p>
            
            <h3 style="font-size: 1.2rem; font-weight: 800; margin-top: 25px; margin-bottom: 12px; color: var(--color-text-main);">1. 初期配置では「麦」と「鉄」の算出量を意識する</h3>
            <p>カタンはゲーム開始時に最初の開拓地を2箇所配置します。この「初期配置」が勝負の8割を決めると言っても過言ではありません。<br>
            初心者はどうしても道や開拓地を作りやすい「木」や「レンガ（粘土）」を重視しがちですが、中盤以降にゲームを有利に進めるためには「麦」と「鉄」が極めて重要になります。<br>
            なぜなら、町を都市（2点）にグレードアップするためには鉄3枚・麦2枚が必要になり、さらに勝利点や強力な効果をもたらす「発展カード」を引くためにも鉄・麦・羊が必要になるからです。最初から麦と鉄が少しでも手に入りやすい場所に陣取ることを意識してみましょう。</p>
            
            <h3 style="font-size: 1.2rem; font-weight: 800; margin-top: 25px; margin-bottom: 12px; color: var(--color-text-main);">2. 交渉では「相手のメリット」を提示して提案する</h3>
            <p>普段、私がIT企業でプロジェクトマネージャー（PM）として複数のチームと交渉するときもそうですが、単に「こちらの欲しい要求」を伝えるだけでは交渉はまとまりません。カタンも全く同じです。<br>
            「誰か麦をください！」と叫ぶだけではなく、周りの手札や状況を見て、「木が足りなくて困っているAさん、私の木を差し上げるので、余っている麦と交換しませんか？」というように、相手が得をする（Win-Winになる）提案を持ちかけるのがコツです。相手の課題を解決する対話を意識すると、交渉の成功率はグッと上がります。</p>

            <h3 style="font-size: 1.2rem; font-weight: 800; margin-top: 25px; margin-bottom: 12px; color: var(--color-text-main);">3. 出やすい「数字の確率」を把握しておく</h3>
            <p>サイコロを2個振るカタンでは、出やすい合計値と出にくい合計値が数学的に決まっています。一番出やすいのは「7」（確率16.7%）で、その次に「6」と「8」（各13.9%）が出やすくなっています。逆に「2」や「12」はほとんど出ません（各2.8%）。<br>
            初期配置や開拓の際には、タイルに書かれた数字が「6」や「8」の場所（数字のフォントが赤く大きく書かれている場所）を優先的に狙うと、資源が手に入る頻度が圧倒的に多くなります。</p>
            ...
            <p>私が主催する東京ボードゲーム会では、プレイしながら優しくルールをレクチャーします。「誰か鉄をくれませんか〜？」と自然に会話が生まれるので、初対面でも一瞬で仲良くなれますよ。初心者の方ばかりのテーブルを作って進めるため、周りのペースを気にせず安心してプレイしていただけます。<br>北千住や新宿などの会場でお待ちしておりますので、ぜひお気軽に遊びに来てくださいね！</p>
    ...
    },
    {
        ...
        summary: "東京（北千住・新宿・東京駅など）でキャッシュフローゲームを体験したい初心者向けコラム。無理な勧誘や営業行為のないオープンな体験イベントの見分け方や学べることを解説します。",
        imagePath: "images/cashflow_game.png",
        content: `
            <p>「キャッシュフローゲームをやってみたいけれど、ネットで検索すると『怪しい』とか『不動産投資の勧誘がある』といった悪い噂が出てきて不安……」<br>そんな風に感じて、参加をためらっていませんか？</p>
            <p>実際、このゲームは投資やビジネスの基本、財務諸表（貸借対照表や損益計算書）の読み方をゲーム感覚で楽しく学ぶのに非常に優れたツールです。しかし、一部のゲーム会や不動産営業を目的とした団体が勧誘 of 手段として利用している事実があるため、怪しまれてしまうのも無理はありません。<br>だからこそ当会は、「純粋にゲームの面白さを体験したい」「怪しい勧誘なしで、お金の勉強の第一歩をフラットに踏み出したい」という投資初心者の方が安心して参加できる、オープンな<strong>体験イベント</strong>を作ることを目的に立ち上げました。</p>
            ...
            <ul style="margin-left: 20px; margin-bottom: 20px; line-height: 1.8;">
                ...
                <li><strong>20代〜30代の会社員が中心</strong>：同じように日々の仕事や将来のお金にモヤモヤを抱える、同世代の仲間たちが集まるのでアットホームです。</li>
            </ul>
