...
const BLOG_POSTS = [
    ...
    },
    {
        ...
        summary: "世界中で大ヒットしているボードゲーム「カタン」の基本ルールと、初心者がすぐに実践できる初期配置のコツを、初心者向けにどこよりもわかりやすく解説します。",
        imagePath: "images/event_catan.jpg",
        content: `
            ...
            <p>今回は、人生ゲームくらいしかやったことがないという初心者の方に向けて、カタンの基本ルールと、検索クエリでも非常に多い<strong>「初期配置のコツ」</strong>を、どこよりもわかりやすく解説します！</p>
            ...
            <h2 style="font-size: 1.4rem; font-weight: 900; margin-top: 40px; margin-bottom: 20px; color: var(--color-text-main); border-bottom: 2px solid var(--color-primary-light); padding-bottom: 8px;">【カタン攻略】初期配置で勝負が決まる！初心者が知るべき配置のコツ</h2>
            ...
            <h3 style="font-size: 1.2rem; font-weight: 800; margin-top: 25px; margin-bottom: 12px; color: var(--color-text-main);">② 「麦と鉄（都市化戦略）」か「木とレンガ（拡大戦略）」か</h3>
            <p>初期配置でどの資源を狙うかによって、そのゲームでの勝ち筋（戦略）が大きく2つに分かれます。</p>
            <ul style="margin-left: 20px; margin-bottom: 20px; line-height: 1.8;">
                <li><strong>麦と鉄を重視する「都市化・カード戦略」：</strong><br>
                ...
                <li><strong>木とレンガを重視する「開拓地拡大・最長交易路（ロンゲスト）戦略」：</strong><br>
            ...
            <p>理想はどちらの資源もバランスよく手に入る場所ですが、開拓地は2箇所しか置けないため、他のプレイヤーの配置状況を見て「今回の自分は麦・鉄ルートでいくか、木・レンガルートでいくか」を決め、初期配置の段階から戦略を一貫させることが勝利への近道です。</p>
            ...
            ゲームが始まると、いくらダイスを振っても彼らの土地の数字が出ず、手札の資源カードはいつまで経ってもゼロのまま。「港はあるのに、交換するための資源が何もない！」という不毛な状態に陥ってしまったのです。16歳の長女から「初期配置は港の近さじゃなくて、数字の確率（ドットの数）が全てだよ！」と諭され、末っ子は「全然カードがもらえない〜！」と大騒ぎ。<br>
