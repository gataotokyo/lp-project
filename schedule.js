...
「お金の知識を身につけたいけれど、何から始めればいいか分からない」「将来のための資産形成や投資に興味があるが難しく考えがち」そんな投資初心者の方へおすすめの東京でのキャッシュフローゲーム会です。`,
    ...
    communication_skills: {
        ...
        subtitle: "東京で大人のコミュニケーションゲーム会を探している方へ。<br>ボードゲームで「伝える力」や「聴く力」を遊びながら鍛える<br>初心者・一人参加歓迎の実践的なワークショップです。<br>東京（新宿・北千住など）開催・参加費無料・サポートあり。",
        badge: "コミュニケーション",
        badgeClass: "online",
        emoji: "💬🎲",
...
const BLOG_POSTS = [
    ...
    },
    {
        ...
        content: `
            ...
            <p>ここまでカタンの魅力や勝つためのコツを解説してきましたが、いかがでしたでしょうか？最初は難しく感じるかもしれませんが、一度遊べばその奥深さにきっと夢中になるはずです。</p>
            <p>東京でカタンを遊んでみたい、もっと強くなりたいと思ったら、まずは私たちの初心者歓迎のイベントに一歩踏み出してみてくださいね。みんなでワイワイ交渉しながら、エキサイティングな開拓の旅へ出かけましょう！</p>
...
,
    {
        ...
        content: `
            ...
            <h2>まとめ</h2>
            <p>難しい投資の知識も、信頼できる仲間とボードゲームを囲みながら体験すれば、驚くほどすんなりと頭に入ってきます。東京で新しい一歩を踏み出してみたい方、遊びながら一生役立つお金の考え方を身につけたい方は、ぜひ私たちのボードゲーム会にお越しください。みなさんと一緒に楽しくプレイできる日を、心より楽しみに待っています！</p>
        `
    },
    {
        id: "post_a1",
