...
const BLOG_POSTS = [
    {
        ...
        content: `
            <p>大人が全力で顔を真っ赤にして演技し、それを見て全員で「今のはどっちだ！？」と大爆笑する。そんな最高の非言語コミュニケーションを体験できるのが、大ヒットゲーム『はぁっていうゲーム』です。このゲーム、本当にシンプルなのに、初対面の人の心理的距離を一瞬でゼロにしてしまう凄まじい破壊力を持っているんです！</p>
            <p>ルールはとても簡単。与えられたお題の「はぁ」を声と表情だけで演じ分け、他の人にどれを演じているか当ててもらうというものです。カードには、さまざまな「はぁ」が書かれています。
            ・怒りの「はぁ」
            ・感心の「はぁ」
            ・とぼけた「はぁ」
            ・失恋したときの「はぁ」
            などなど。演じる人は身振り手振りは使えず、声と顔の表情だけでこれを表現しなければなりません。</p>
            <p>「はぁ？」と一言発しただけで、その人の個性が爆発します。ある人が全力で怒りの「はぁ」をやったつもりが、周りからは「ため息にしか聞こえない（笑）」と突っ込まれたり、意外なほど演技力が高くて「おおー！」と拍手が起きたり。演技の上手い下手は関係ありません。むしろ、お互いの伝わらなさや表現の「ズレ」こそが最高に面白く、大の大人が声をあげて子供のように笑い合えるんです。</p>
            <p>「会話のきっかけが掴めない」「なんとなく場の空気を柔らかくしたい」そんなときにこのゲームを遊ぶと、一瞬で部屋全体の緊張がほぐれて、お互いの人柄が身近に感じられるようになります。言葉を超えて心を通わせるアナログゲームならではの楽しさを、ぜひ僕たちと一緒に体験してみませんか？</p>
    ...
    },
    {
        ...
        content: `
            <p>僕たちが普段、何気なく使っている言葉。「ハンバーガー」「スニーカー」「ログイン」「インターネット」……。実は、身の回りはカタカナ語であふれかえっています。そんなカタカナ語を「一切使わずに」お題を相手に説明するゲーム, それが『カタカナーシ』です。これがもう, 大人が本気で悶絶して, お腹を抱えて大爆笑できる最高のゲームなんです！</p>
            <p>ルールはシンプルで、カードに書かれたカタカナのお題（たとえば「ログイン」）を、カタカナを1回も使わずに説明します。もし「ログイン」をお題に引いたら、あなたならどう説明しますか？「電子の箱に自分の秘密の符号を入れて、中の部屋に入ること……」とか、必死に頭をフル回転させます。つい「スマホのボタンを……」と言ってしまい、「あ！スマホって言った！」と全員から突っ込まれて爆笑が起きる。言葉の制限があるからこそ、普段の思考のクセが丸裸になって、説明する人のユニークな知恵や人柄が浮き彫りになるんです。</p>
            <p>以前のゲーム会で、「インターネット」をお題にした人が「世界中のすべての電脳の糸が繋がっていて、見えない情報が飛び交う蜘蛛の巣のようなもの」と、まるで詩人のように説明してくれたことがあって、全員で「おおー！」と感動したあとに大正解して大盛り上がりしました（笑）。</p>
            <p>このゲームの素晴らしいところは、初対面の人同士でも「言葉が通じないもどかしさ」を通じて、一瞬で心の壁が壊れて仲良くなれることです。人見知りで会話が苦手な人にこそ、この魔法のゲームを体験してほしいなと思います。大笑いしながら、言葉で繋がる楽しさを一緒に味わいましょう！</p>
            <p>※関連するイベント詳細はこちら：<a href="/events/communication">伝わる!コミュニケーション力向上ワークショップ</a></p>
