...
const eventsIndexHtml = renderTemplate(eventsIndexContent, {
    title: 'ボードゲーム会 東京一覧｜初心者歓迎・カタン・モノポリー・社会人向け',
...
Object.keys(GAME_MEETING_TYPES).forEach(key => {
    ...
    const eventSeoMeta = {
        ...
        monopoly: {
            title: 'モノポリー会 東京 初心者向け｜投資と交渉をゲームで学ぶ',
        ...
        nisa: {
            title: 'NISAボードゲーム会 東京｜投資初心者が遊びながら学べる会',
...
BLOG_POSTS.forEach((post, index) => {
    ...
    const blogSeoMeta = {
        ...
        'catan-rules': {
            ...
            description: '初心者でも安心！世界中で大ヒットしているボードゲーム「カタン」の基本ルールを、所要時間やプレイ人数、サイコロの確率、初期配置のコツを交えて簡単にわかりやすく解説します。'
        },
        'cashflow-game': {
            title: '【東京】勧誘なしで安心！キャッシュフローゲーム初心者体験イベント',
            description: '東京でキャッシュフローゲームを体験したい初心者向けコラム。IT企業PMの主催者が、無理な勧誘のない安全な初心者体験イベントの見分け方や学びのポイントを解説します。'
        },
        ...
        'catan-beginner-tips': {
            title: 'カタン攻略・初期配置のコツ完全ガイド｜東京カタン会主催者が解説',
            description: 'カタン初心者が知っておくべき攻略法・初期配置のコツ・勝つための戦略を東京カタン会の主催者が解説。失敗しやすいポイントと対策も紹介。東京でカタンを学べるボードゲーム会も開催中。'
        },
        'nisa-board-game': {
        ...
        'beginner-guide-tokyo': {
            title: '【注意】マルチ勧誘の温床？失敗しない東京のボードゲーム会の選び方',
            description: '東京（北千住・新宿など）でボードゲーム会を探している初心者の方へ。キャッシュフローゲーム等を利用したマルチ商法や宗教勧誘の手口と、安全で純粋にゲームを楽しめるクリーンな環境の見分け方を徹底解説します。'
        },
        'negotiation-skills': {
        ...
        'investment-board-game': {
            title: '投資を学べるボードゲーム3選｜東京で体験できるゲーム会も紹介',
            description: '投資・お金の流れをボードゲームで楽しく学ぶ方法を解説。NISAボードゲーム・キャッシュフローゲーム・モノポリーで資産形成の考え方が身につく。東京開催のゲーム会も紹介。'
        },
        'board-game-event-beginner': {
            title: 'ボードゲーム会 初心者が最初に読む完全ガイド【東京版】',
            description: 'ボードゲーム会に初めて参加する方が不安に思うことをすべて解説。持ち物・服装・一人参加・ルールを知らなくても大丈夫な理由まで。東京で開催中の初心者向けボードゲーム会も紹介。'
        },
        'board-game-event-friends': {
            title: 'ボードゲーム会 出会い・友達はできる？主催者が解説【東京版】',
            description: 'ボードゲーム会は友達作りや新しい出会いの場として注目されています。初対面でも打ち解けやすい理由・実際の参加者の声・東京で参加できるボードゲーム会を紹介。'
        },
        'board-game-event-trouble': {
            title: 'ボードゲーム会 トラブル・出禁になる行為と安心参加のコツ',
            description: 'ボードゲーム会でよくあるトラブルや出禁になる行為を解説。参加前に知っておきたいマナー・ルールと、安心して参加できる会の選び方を東京開催の主催者が紹介。'
        }
    };
